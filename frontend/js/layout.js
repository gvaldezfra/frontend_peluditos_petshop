...
export function renderizarLayout() {
    ...
    const iconoTema = temaGuardado === "dark" ? "☀️" : "🌙";
        ...
        <header id="header">
            <div class="header-content">
                ...
                <nav class="header-nav">
                    ...
                    <button id="btn-theme-toggle" class="btn btn-ghost" style="font-size: 1.5rem; margin-left: 15px; padding: 0 10px;">${iconoTema}</button>
                </nav>
            </div>
        </header>
    `;
    ...
    footerContainer.innerHTML = `
        <footer>
            ...
            <a href="../views/admin/login.html" class="admin-link">Ingresar como administrador</a>
        </footer>
    `;
}
